...
export default function GuidanceDashboard() {
  const guidanceCategories = [
    ...
    {
      href: '/guidance/use-cases',
      title: 'Use Cases',
      description: 'Group workflows into logical use cases for discovery and organization',
      icon: (
    ...
    {
      href: '/guidance/workflow-executions',
      title: 'Execution History',
      description: 'View workflow execution history and step-by-step results',
      icon: (
